...
data PieceOnSquare p = PieceOnSquare
  { piece :: Piece p,
    square :: Square
  }

-- instance Ord (PieceOnSquare p) where
...
-- initialPass' :: p -> String -> [PieceOnSquare p]
